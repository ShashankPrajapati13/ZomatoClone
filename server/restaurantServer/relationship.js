...
Restaurant.belongsTo(RestaurantManager, { foreignKey: 'restaurantManagerId',as: 'manager' });

// RestaurantManager associations
RestaurantManager.belongsTo(User, { foreignKey: 'userId', as: 'user' });
